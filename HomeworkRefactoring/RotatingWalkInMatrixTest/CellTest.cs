...
namespace RotatingWalkInMatrix.Tests
{
    ...
    public class CellTests
    {
        ...
        [TestMethod]
        public void AddingTwoCells_ShouldReturnANewCellWithProperValuesForXAndY()
        {
        ...
        public void AddingTwoCells_ShouldThrowAnArgumentNullExceptionWhenEitherOfTheOperandsIsNull()
        {
